        ...
        return array(
            ...
            'settings' => array(
                ...
                'notices' => array(
                    ...
                    'interval_not_in_service_schedule' => __( 'Selected period doesn\'t match service schedule', 'bookly-responsive-appointment-booking-tool' ),
                    ...
                    'overflow_capacity' => __( 'The number of customers should not be more than %d', 'bookly-responsive-appointment-booking-tool' ),
                    'service_required' => __( 'Please select a service', 'bookly-responsive-appointment-booking-tool' ),
                    'staff_reaches_working_time_limit' => __( 'Booking exceeds your working hours limit', 'bookly-responsive-appointment-booking-tool' ),
