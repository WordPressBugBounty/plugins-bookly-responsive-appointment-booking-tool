    ...
    <div class="bookly-modal-dialog">
        <div class="bookly-modal-content bookly-js-modal-content">
            <div class="bookly-modal-header">
                <div><?php esc_html_e( 'Verification code', 'bookly-responsive-appointment-booking-tool' ) ?></div>
            ...
            <div class="bookly-modal-footer">
                <button class="bookly-btn-submit bookly-js-resend-button" type="submit" disabled><?php esc_html_e( 'Resend', 'bookly-responsive-appointment-booking-tool' ) ?><span class="bookly-js-resend-timer bookly-font-mono"></span></button>
                <button class="bookly-btn-submit bookly-js-verify-button" type="submit"><?php esc_html_e( 'Verify', 'bookly-responsive-appointment-booking-tool' ) ?></button>
            </div>
        </div>
    </div>
</div>