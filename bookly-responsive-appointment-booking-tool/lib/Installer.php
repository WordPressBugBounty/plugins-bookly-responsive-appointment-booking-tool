...
class Installer extends Base\Installer
{
    ...
    {
        // l10n.
        load_plugin_textdomain( 'bookly-responsive-appointment-booking-tool', false, Plugin::getSlug() . '/languages' );
        ...
        $this->notifications[] = array(
            ...
            'name' => __( 'Notification to customer about approved appointment', 'bookly-responsive-appointment-booking-tool' ),
            'subject' => __( 'Your appointment information', 'bookly-responsive-appointment-booking-tool' ),
        ...
        $this->notifications[] = array(
            'gateway' => 'email',
            'type' => Notification::TYPE_NEW_BOOKING,
            'name' => __( 'Notification to staff member about approved appointment', 'bookly-responsive-appointment-booking-tool' ),
            'subject' => __( 'New booking information', 'bookly-responsive-appointment-booking-tool' ),
            'message' => __( "Hello.\n\nYou have a new booking.\n\nService: {service_name}\nDate: {appointment_date}\nTime: {appointment_time}\nClient name: {client_name}\nClient phone: {client_phone}\nClient email: {client_email}", 'bookly-responsive-appointment-booking-tool' ),
            'active' => 1,
            'to_staff' => 1,
            'settings' => $settings,
        );
        ...
        $this->notifications[] = array(
            ...
            'name' => __( 'Notification to customer about cancelled appointment', 'bookly-responsive-appointment-booking-tool' ),
            'subject' => __( 'Booking cancellation', 'bookly-responsive-appointment-booking-tool' ),
        ...
        $this->notifications[] = array(
            'gateway' => 'email',
            'type' => Notification::TYPE_CUSTOMER_APPOINTMENT_STATUS_CHANGED,
            'name' => __( 'Notification to staff member about cancelled appointment', 'bookly-responsive-appointment-booking-tool' ),
            'subject' => __( 'Booking cancellation', 'bookly-responsive-appointment-booking-tool' ),
        ...
        $this->notifications[] = array(
            'gateway' => 'email',
            'type' => Notification::TYPE_CUSTOMER_APPOINTMENT_STATUS_CHANGED,
            'name' => __( 'Notification to customer about rejected appointment', 'bookly-responsive-appointment-booking-tool' ),
            'subject' => __( 'Booking rejection', 'bookly-responsive-appointment-booking-tool' ),
        ...
        $this->notifications[] = array(
            'gateway' => 'email',
            'type' => Notification::TYPE_CUSTOMER_APPOINTMENT_STATUS_CHANGED,
            'name' => __( 'Notification to staff member about rejected appointment', 'bookly-responsive-appointment-booking-tool' ),
            'subject' => __( 'Booking rejection', 'bookly-responsive-appointment-booking-tool' ),
        ...
        $this->notifications[] = array(
            'gateway' => 'sms',
            'type' => Notification::TYPE_APPOINTMENT_REMINDER,
            'name' => __( 'Follow-up message in the same day after appointment (requires cron setup)', 'bookly-responsive-appointment-booking-tool' ),
        ...
        $this->notifications[] = array(
            ...
            'name' => __( 'Evening notification with the next day agenda to staff member (requires cron setup)', 'bookly-responsive-appointment-booking-tool' ),
            'message' => __( "Hello.\nYour agenda for tomorrow is:\n{next_day_agenda}", 'bookly-responsive-appointment-booking-tool' ),
            'to_staff' => 1,
            'settings' => $settings,
        );
        $this->notifications[] = array(
        ...
        $this->options = array(
            ...
            'bookly_l10n_button_apply' => __( 'Apply', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_button_back' => __( 'Back', 'bookly-responsive-appointment-booking-tool' ),
            ...
            'bookly_l10n_info_complete_step' => __( 'Thank you! Your booking is complete. An email with details of your booking has been sent to you.', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_info_complete_step_limit_error' => __( 'You are trying to use the service too often. Please contact us to make a booking.', 'bookly-responsive-appointment-booking-tool' ),
            ...
            'bookly_l10n_label_category' => __( 'Category', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_label_email' => __( 'Email', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_label_email_confirm' => __( 'Confirm email', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_label_employee' => __( 'Staff', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_label_finish_by' => __( 'Finish by', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_label_name' => __( 'Full name', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_label_first_name' => __( 'First name', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_label_last_name' => __( 'Last name', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_label_notes' => __( 'Notes', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_label_pay_locally' => __( 'I will pay locally', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_label_pay_cloud_stripe' => __( 'I will pay now with Credit Card', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_label_phone' => __( 'Phone', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_label_select_date' => __( 'I\'m available on or after', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_label_service' => __( 'Service', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_label_start_from' => __( 'Start from', 'bookly-responsive-appointment-booking-tool' ),
            ...
            'bookly_l10n_option_category' => __( 'Select category', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_option_employee' => __( 'Any', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_option_service' => __( 'Select service', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_option_day' => __( 'Select day', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_option_month' => __( 'Select month', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_option_year' => __( 'Select year', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_required_email' => __( 'Please tell us your email', 'bookly-responsive-appointment-booking-tool' ),
            ...
            'bookly_l10n_required_employee' => __( 'Please select an employee', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_required_name' => __( 'Please tell us your name', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_required_first_name' => __( 'Please tell us your first name', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_required_last_name' => __( 'Please tell us your last name', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_required_phone' => __( 'Please tell us your phone', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_required_service' => __( 'Please select a service', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_step_service' => __( 'Service', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_step_time' => __( 'Time', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_step_time_slot_not_available' => __( 'The selected time is not available anymore. Please, choose another time slot.', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_step_details' => __( 'Details', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_step_details_button_login' => __( 'Login', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_step_payment' => __( 'Payment', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_step_done' => __( 'Done', 'bookly-responsive-appointment-booking-tool' ),
            ...
            // Button Next.
            'bookly_l10n_step_service_button_next' => __( 'Next', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_step_service_mobile_button_next' => __( 'Next', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_step_details_button_next' => __( 'Next', 'bookly-responsive-appointment-booking-tool' ),
            'bookly_l10n_step_payment_button_next' => __( 'Next', 'bookly-responsive-appointment-booking-tool' ),
            // Calendar.
            'bookly_cal_show_only_business_days' => '1',
            'bookly_cal_show_only_business_hours' => '1',
            'bookly_cal_show_only_staff_with_appointments' => '1',
            'bookly_cal_one_participant' => '{service_name}' . "\n" . '{client_name}' . "\n" . '{client_phone}' . "\n" . '{client_email}' . "\n" . '{total_price} {payment_type} {payment_status}' . "\n" . __( 'Status', 'bookly-responsive-appointment-booking-tool' ) . ': {status}' . "\n" . __( 'Signed up', 'bookly-responsive-appointment-booking-tool' ) . ': {signed_up}' . "\n" . __( 'Capacity', 'bookly-responsive-appointment-booking-tool' ) . ': {service_capacity}',
    ...
    public function createTables()
    {
        ...
        $wpdb->query(
            'CREATE TABLE IF NOT EXISTS `' . Entities\Payment::getTableName() . '` (
                ...
                `type`         ENUM("local","free","paypal","authorize_net","stripe","2checkout","payu_biz","payu_latam","payson","mollie","woocommerce","cloud_stripe","cloud_square","worldpay") NOT NULL DEFAULT "local",
