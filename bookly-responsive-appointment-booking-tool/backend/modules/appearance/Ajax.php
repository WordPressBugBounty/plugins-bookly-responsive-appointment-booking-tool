...
class Ajax extends Lib\Base\Ajax
{
    ...
    /**
     * Get list of modern appearance forms (picker infrastructure).
     */
    public static function getFormsList()
    {
        ...
        foreach ( $forms as &$form ) {
            $form['settings'] = ModernAppearance::prepareAppearanceSettings( $form['type'], $form );
        }
        unset ( $form );
    ...
    public static function saveAppearance()
    {
        ...
        self::registerModernAppearanceWpmlStrings( $settings['l10n'] );
    ...
    /**
     * Delete a modern appearance form.
     */
    ...
    /**
     * Clone a modern appearance form.
     */
    ...
    /**
     * Dismiss the modern appearance picker notice for current user.
     */
    public static function dismissModernAppearanceNotice()
    {
     ...
     * @return void
     */
    protected static function registerModernAppearanceWpmlStrings( $strings )
    {
        foreach ( $strings as $text ) {
            if ( is_array( $text ) ) {
                self::registerModernAppearanceWpmlStrings( $text );
            } else {
