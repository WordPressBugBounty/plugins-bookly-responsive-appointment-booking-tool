        ...
        <div class="modal-content">
            <form>
                <div class="modal-header">
                    <h5 class="modal-title"><?php esc_html_e( 'Test email notifications', 'bookly-responsive-appointment-booking-tool' ) ?></h5>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="bookly_test_to_email"><?php esc_html_e( 'To email', 'bookly-responsive-appointment-booking-tool' ) ?></label>
                            ...
                            <div class="form-group">
                                <div class="bookly-dropdown">
                                    <button class="btn btn-default bookly-dropdown-toggle" data-toggle="bookly-dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
                                        <?php esc_html_e( 'Notification templates', 'bookly-responsive-appointment-booking-tool' ) ?>
                                        (<span class="bookly-js-count">0</span>)
                                    </button>
                                    <div class="bookly-dropdown-menu">
                                        <div class="bookly-dropdown-item my-0 pl-3">
                                            <?php Inputs::renderCheckBox( __( 'All templates', 'bookly-responsive-appointment-booking-tool' ), null, null, array( 'id' => 'bookly-check-all-entities' ) ) ?>
                                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <?php Buttons::render( null, 'btn-success', __( 'Send', 'bookly-responsive-appointment-booking-tool' ), array( 'disabled' => 'disabled' ) ) ?>
                </div>
            </form>
        </div>
    </div>
