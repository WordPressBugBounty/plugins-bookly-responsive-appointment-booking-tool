...
<div id="bookly-tbs" class="wrap bookly-css-root bookly-main-page-wrap">
    <?php PageHeaderRenderer::render( $self::pageSlug(), __( 'Voice Notifications', 'bookly-responsive-appointment-booking-tool' ) ) ?>
    <div class="bookly:card">
        ...
        <div class="bookly:card-footer bookly:justify-end bookly-js-voice-settings-footer" hidden>
            <?php Buttons::renderSubmit( null, 'bookly-js-voice-settings-save', __( 'Save', 'bookly-responsive-appointment-booking-tool' ) ) ?>
        </div>
    </div>
