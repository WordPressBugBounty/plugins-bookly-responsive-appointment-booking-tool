...
class Page extends Lib\Base\Component
{
    ...
    public static function render()
    {
        ...
        if ( ! $cloud->account->loadProfile() ) {
            Components\Cloud\LoginRequired\Page::render( __( 'Bookly Cloud Settings', 'bookly-responsive-appointment-booking-tool' ), self::pageSlug() );
        } else {
            ...
            wp_localize_script( 'bookly-cloud-settings.js', 'BooklyL10n', array(
                ...
                'passwords_no_match' => __( 'Passwords don\'t match', 'bookly-responsive-appointment-booking-tool' ),
            ) );
