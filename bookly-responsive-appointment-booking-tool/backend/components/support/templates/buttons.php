...
if ( isset ( $demo_links[ $page_slug ] ) ) :
    ...
    ?>
    <div class="col-auto">
        <a class="btn btn-default" title="<?php esc_attr_e( 'View this page at Bookly Pro Demo', 'bookly-responsive-appointment-booking-tool' ) ?>"
                <?php if ( $dismiss ) : ?>
                ...
                <?php endif ?>
        >
            <i class="fas fa-fw fa-certificate"></i><span class="d-none d-lg-inline ms-2"><?php esc_html_e( 'View this page at Bookly Pro Demo', 'bookly-responsive-appointment-booking-tool' ) ?></span>
        </a>
        <?php if ( ! $dismiss ) : ?>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>
                                <?php esc_html_e( 'The demo is a version of Bookly Pro with all installed add-ons so that you can try all the features and capabilities of the system and then choose the most suitable configuration according to your business needs.', 'bookly-responsive-appointment-booking-tool' ) ?>
                            </p>
                        ...
                        <div class="modal-footer">
                            <?php Buttons::renderSubmit( null, 'bookly-js-proceed-to-demo', __( 'Proceed to demo', 'bookly-responsive-appointment-booking-tool' ), array( 'data-target' => $target ) ) ?>
...
?>
    <div class="col-auto">
        <a href="<?php echo esc_url( 'https://hub.bookly.pro/go/' . $page_slug ) ?>" id="bookly-help-btn" target="_blank" class="btn btn-default" title="<?php esc_attr_e( 'Documentation', 'bookly-responsive-appointment-booking-tool' ) ?>">
            <i class="far fa-question-circle"></i><span class="d-none d-lg-inline ms-2"><?php esc_html_e( 'Documentation', 'bookly-responsive-appointment-booking-tool' ) ?></span>
        </a>
    </div>
...
?>
    <div class="col-auto">
        <a href="#bookly-contact-us-modal" id="bookly-contact-us-btn" class="btn btn-default" title="<?php esc_attr_e( 'Contact us', 'bookly-responsive-appointment-booking-tool' ) ?>" data-toggle="bookly-modal"
                <?php if ( $show_contact_us_notice ) : ?>
                    data-processed="false"
                    data-content="<?php echo esc_attr( '<button type="button" class="close ms-2"><span>&times;</span></button>' . __( 'Need help? Contact us here.', 'bookly-responsive-appointment-booking-tool' ) ) ?>"
                <?php endif ?>
        >
            <i class="fas fa-headset"></i><span class="d-none d-lg-inline ms-2"><?php esc_html_e( 'Contact us', 'bookly-responsive-appointment-booking-tool' ) ?></span>
        </a>
...
?>
    <div class="col-auto">
        <a class="btn btn-default" title="<?php esc_attr_e( 'Feature requests', 'bookly-responsive-appointment-booking-tool' ) ?>"
                <?php if ( $dismiss ) : ?>
                ...
                <?php endif ?>
        >
            <i class="far fa-lightbulb"></i><span class="d-none d-lg-inline ms-2"><?php esc_html_e( 'Feature requests', 'bookly-responsive-appointment-booking-tool' ) ?></span>
        </a>
        <?php if ( ! $dismiss ) : ?>
            <div id="bookly-feature-requests-modal" class="bookly-modal bookly-fade text-left" tabindex=-1>
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>
                                <?php esc_html_e( 'In the Feature Requests section of our Community, you can make suggestions about what you\'d like to see in our future releases.', 'bookly-responsive-appointment-booking-tool' ) ?>
                            </p>
                            <p>
                                <?php esc_html_e( 'Before you post, please check if the same suggestion has already been made. If so, vote for ideas you like and add a comment with the details about your situation.', 'bookly-responsive-appointment-booking-tool' ) ?>
                            </p>
                            <p>
                                <?php esc_html_e( 'It\'s much easier for us to address a suggestion if we clearly understand the context of the issue, the problem, and why it matters to you. When commenting or posting, please consider these questions so we can get a better idea of the problem you\'re facing:', 'bookly-responsive-appointment-booking-tool' ) ?>
                            </p>
                            <ul>
...
?>
    <div class="col-auto">
        <a href="<?php echo Utils\Common::prepareUrlReferrers( Urls::REVIEWS_PAGE, 'feedback' ) ?>" id="bookly-feedback-btn" target="_blank" class="btn btn-default" title="<?php esc_attr_e( 'Feedback', 'bookly-responsive-appointment-booking-tool' ) ?>"
                <?php if ( $show_feedback_notice ) : ?>
                    data-content="<?php echo esc_attr( '<button type="button" class="close ms-2"><span>&times;</span></button>' . __( 'We care about your experience of using Bookly!<br/>Leave a review and tell others what you think.', 'bookly-responsive-appointment-booking-tool' ) ) ?>"
                <?php endif ?>
        >
            <i class="far fa-comment-dots"></i><span class="d-none d-lg-inline ms-2"><?php esc_html_e( 'Feedback', 'bookly-responsive-appointment-booking-tool' ) ?></span>
        </a>
    </div>
