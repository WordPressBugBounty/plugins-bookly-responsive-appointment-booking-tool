...
<div class="wrap bookly-css-root bookly-notice-wrap">
    <div id="bookly-powered-by" class="bookly:alert bookly:alert-info" data-action="bookly_dismiss_powered_by_notice">
        ...
        <div class="bookly:alert-content">
            ...
            <div class="bookly:alert-actions">
                <button type="button" id="bookly-show-powered-by" class="bookly:alert-btn bookly:alert-btn-primary"><?php esc_html_e( 'Agree', 'bookly-responsive-appointment-booking-tool' ) ?></button>
