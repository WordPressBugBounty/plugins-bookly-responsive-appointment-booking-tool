        ...
        <div class="form-row">
            ...
            <div class="col">
                <?php if ( $enabled ): ?>
                    ...
                    <div class="mt-2">
                        <button type="button" class="btn btn-default" data-dismiss="alert"><?php esc_html_e( 'Close', 'bookly-responsive-appointment-booking-tool' ) ?></button>
                    </div>
                <?php else: ?>
                    ...
                    <div class="mt-2">
                        <?php Buttons::render( 'bookly-enable-collecting-stats-btn', 'btn-success', __( 'Agree', 'bookly-responsive-appointment-booking-tool' ) ) ?>
